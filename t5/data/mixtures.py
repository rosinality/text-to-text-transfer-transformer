...
MixtureRegistry.add(
    ...
    [
        ...
        ("wikipedia_ul2", 6.5),
        ("redpajama_stackexchange_ul2", 2.5),
        ("redpajama_arxiv_ul2", 4.5),
        ("redpajama_book_ul2", 6.5),
        ("redpajama_github_ul2", 5.0),
        ("redpajama_common_crawl_ul2", 43.5),
...
MixtureRegistry.add(
    ...
    [
        ...
        ("redpajama_arxiv_ul2", 4.5),
        ("redpajama_book_ul2", 4.5),
        ("redpajama_github_ul2", 5),
        ("redpajama_common_crawl_ul2", 33.),
        ("the_stack_dedup_ul2", 30.),
    ],
    default_rate=1.,
)
...
MixtureRegistry.add(
    "mix_full_lm_test",
    [
        ("redpajama_common_crawl_full_lm", 51.5),
        ("redpajama_c4_full_lm", 15.),
        ("redpajama_wikipedia_full_lm", 4.5),
        ("redpajama_stackexchange_full_lm", 2.0),
        ("redpajama_arxiv_full_lm", 2.5),
        ("redpajama_github_full_lm", 4.5),
        ("the_stack_dedup_full_lm", 20.0),
     ],
    default_rate=1.,
)
